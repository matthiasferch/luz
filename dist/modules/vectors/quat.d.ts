...
export declare class quat extends Float32Array {
    ...
    interpolate(q: quat, time: number, dest?: null | quat): quat;
    serialize(): number[];
    static deserialize(values: number[]): Promise<quat>;
    static interpolate(q1: quat, q2: quat, time: number, dest?: null | quat): quat;
